...
python train.py \
    ...
    exp_name=real_bin_push_ensemble_test \
    discount=0.95 \
    train_steps=100000 \
    seed=1 \
    demos=3 \
...
#bc_model_fp='/mnt/raid5/data/plancaster/robohive_base/models/franka-FrankaBinPushReal_v2d/bin_push_real_bc_100demos/bc_seed1.pt' \