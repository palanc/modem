...
python eval_agent.py  -m \
    ...
    exp_name=planar_push_img-final-vanilla-modem-safety-eval \
    iterations=1\
    discount=0.95 \
    train_steps=200000 \
    seed=1,2,3,4,5 \
    ...
    eval_dir='/checkpoint/plancaster/outputs/robohive_base/logs/franka-FrankaPlanarPush_v2d/planar_push_img-final-vanilla-modem' \
